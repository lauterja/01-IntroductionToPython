...
natasha.pen = rg.Pen('orange', 25)  # Second argument is the Pen's thickness
natasha.speed = 10  # Bigger means faster, max is usually about 10
boris = rg.SimpleTurtle('turtle')
boris.pen = rg.Pen('green', 25)
boris.speed = 7
sam = rg.SimpleTurtle('turtle')
sam.pen = rg.Pen('silver', 25)
sam.speed = 4
...
boris.speed = 10
boris.go_to(rg.Point(300,300))
sam.speed = 7
sam.go_to(rg.Point(0,0))
###############################################################################
#
# DONE: 4.
